...
const ProjectCard = ({
  ...
  return (
    <div className="bg-slate-700 rounded-md p-4 relative w-full h-[180px]  flex-col flex items-start justify-start gap-6">
      ...
      <div className="absolute bottom-4 w-full flex flex-row items-start justify-start ">
        <span className="mr-2 flex flex-row items-center justify-start">
          <FaStar className="text-md text-green-600" />
          <FaStar className="text-md text-green-600" />
          <FaStar className="text-md text-green-600" />
        ...
        <span className="ml-4 flex flex-row items-center justify-start ">
          <FaGithub className="text-md text-green-600" />
          <small className="ml-2 text-sm text-white-200 font-extrabold">
            {forks}
          </small>
      ...
      <a
        ...
        className="absolute right-4 top-2 cursor-pointer flex flex-row items-center"
      >
